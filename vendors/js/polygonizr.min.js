...
this.isRunning=!1;this.start=function(){if(!this.isRunning){this.isRunning=!0;m_duration=duration*1000;m_delay=delay*1000;m_requestId=requestAnimationFrame(step)}};this.pause=function(){if(this.isRunning){cancelAnimationFrame(m_requestId);this.isRunning=!1;m_startTime=null;m_frameCount=-1}};var m_requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame;var m_startTime=null;var m_frameCount=-1
